...
public class QueryExtensionsTests
{
    ...
    public async Task W_FiltersRows()
    {
        ...
        (await db.Things.w(t => t.Rank >= 2).lst()).Count.eq(2);
    }
    ...
    public async Task S_Projects()
    {
        ...
        (await db.Things.ob(t => t.Rank).s(t => t.Name).lst()).eqSeq(new[] { "a", "b", "c" });
    }
    ...
    public async Task ObdAndPaging_Work()
    {
        ...
        (await db.Things.obd(t => t.Rank).sk(1).tk(1).s(t => t.Name).lst()).eqSeq(new[] { "b" });
    }
    ...
    public async Task ObThenBy_Work()
    {
        ...
        (await db.Things.ob(t => t.Rank).tb(t => t.Name).s(t => t.Name).lst()).eqSeq(new[] { "a", "b", "c" });
    }
    ...
    public async Task One_ReturnsMatchOrNull()
    {
        ...
        (await db.Things.w(t => t.Name == "a").one()).notNul();
        (await db.Things.w(t => t.Name == "zzz").one()).nul();
    }
    ...
    public async Task Single_ReturnsMatch()
    {
        ...
        (await db.Things.w(t => t.Rank == 3).single())!.Name.eq("c");
    }
    ...
    public async Task AnyAndCount_Work()
    {
        ...
        (await db.Things.any()).tru();
        (await db.Things.w(t => t.Rank > 99).any()).fls();
        (await db.Things.cnt()).eq(3);
    }
    ...
    public async Task Nt_DoesNotTrack()
    {
        ...
        var db = TestDbFactory.Create(name);
        (await db.Things.nt().w(t => t.Name == "a").one()).notNul();
